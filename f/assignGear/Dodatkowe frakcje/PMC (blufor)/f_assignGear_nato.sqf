...
// Standard Riflemen ( MMG Assistant Gunner, Assistant Automatic Rifleman, MAT Assistant Gunner, MTR Assistant Gunner, Rifleman,  Rifleman (AT))
_rifle = "hlc_rifle_RU556";
_riflemag = "30Rnd_556x45_Stanag";
_riflemag_tr = "30Rnd_556x45_Stanag_Tracer_Red";

// Standard Carabineer (Medyk, MAT Gunner, MTR Gunner, Carabineer)
...
_bagFTL = "tf_rt1523g_bwmod";    // Plecak dla dowódcy (radio)
...
_baseUniform = ["U_I_G_resistanceLeader_F","LOP_U_PMC_Fatigue_01","LOP_U_PMC_Fatigue_03","U_BG_Guerilla2_2","U_BG_Guerilla2_1","U_BG_Guerilla2_3","U_I_G_Story_Protagonist_F"];
_baseHelmet = ["H_Cap_headphones","rhsusf_bowman_cap","H_Cap_usblack","H_Cap_blk","H_Cap_oli_hs","H_Cap_oli","H_Cap_khaki_specops_UK"];
_baseGlasses = [];

// Vests
_lightRig = ["V_PlateCarrier1_blk","V_TacVestIR_blk","V_PlateCarrier1_rgr","V_TacVest_brn","V_TacVest_oli","V_PlateCarrierL_CTRG"];
_mediumRig = ["V_PlateCarrier1_blk","V_TacVestIR_blk","V_PlateCarrier1_rgr","V_TacVest_brn","V_TacVest_oli","V_PlateCarrierL_CTRG"]; 	// default for all infantry classes
_heavyRig = ["V_PlateCarrier1_blk","V_TacVestIR_blk","V_PlateCarrier1_rgr","V_TacVest_brn","V_TacVest_oli","V_PlateCarrierL_CTRG"];

// Diver
_diverUniform =  ["LOP_U_PMC_Fatigue_02"];
_diverHelmet = [];
_diverRig = [];
_diverGlasses = [];

// Pilot
_pilotUniform = ["LOP_U_PMC_Fatigue_02"];
_pilotHelmet = ["H_PilotHelmetHeli_B"];
_pilotRig = ["V_TacVest_blk"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["LOP_U_PMC_Fatigue_02"];
...
// należy skopiować inicjalizacje VIP i wpisać ją w inicjalizacji cywila w edytorze aby wszystko 
// działało poprawnie
...
// LOADOUT:VIP  
  ...
  this addVest "LOP_V_Carrier_BLK";
