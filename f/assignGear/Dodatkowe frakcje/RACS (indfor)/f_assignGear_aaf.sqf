...
_bagAR = "B_FieldPack_cbr";                     // Plecak dla RKM
_bagENG = "B_Kitbag_cbr";   // Plecak dla Mechanika
_bagR = "B_AssaultPack_cbr";				// Plecak dla strzelca, strzelca AT
_bagmedium = "B_FieldPack_cbr";			// carries 200, weighs 30
...
_baseHelmet = ["LOP_H_6B27M_ess_RACS","LOP_H_6B27M_RACS"];
_baseGlasses = [];

// Vests
_lightRig = ["LOP_V_CarrierLite_TAN","LOP_V_CarrierLite_WDL","LOP_V_CarrierRig_TAN","LOP_V_CarrierRig_WDL"];
_mediumRig = ["LOP_V_CarrierLite_TAN","LOP_V_CarrierLite_WDL","LOP_V_CarrierRig_TAN","LOP_V_CarrierRig_WDL"]; 	// default for all infantry classes
_heavyRig = ["LOP_V_CarrierLite_TAN","LOP_V_CarrierLite_WDL","LOP_V_CarrierRig_TAN","LOP_V_CarrierRig_WDL"];
...
if (_isMan) then {
	...
	//_unit linkItem "ItemGPS"; 	// Dodanie GPS (wylczone)
