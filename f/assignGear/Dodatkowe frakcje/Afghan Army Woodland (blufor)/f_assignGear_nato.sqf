...
_bagFTL = "tf_anprc155";      // Plecak dla dowódcy (radio)
_bagMedic = "B_Carryall_oli";       // Plecak dla medyka
_bagAR = "B_TacticalPack_rgr";    // Plecak dla RKM
_bagENG = "rhs_assault_umbts_engineer_empty";                // Plecak dla Mechanika
_bagR = "B_AssaultPack_dgtl";				// Plecak dla strzelca, strzelca AT
...
_baseUniform = ["LOP_U_AA_Fatigue_02_slv"];
_baseHelmet = ["LOP_H_6B27M_ess_ANA"];
_baseGlasses = [];

// Vests
_lightRig = ["LOP_V_CarrierLite_ANA","LOP_V_CarrierRig_ANA"];
_mediumRig = ["LOP_V_CarrierLite_ANA","LOP_V_CarrierRig_ANA"]; 	// default for all infantry classes
_heavyRig = ["LOP_V_CarrierLite_ANA","LOP_V_CarrierRig_ANA"];
...
// Pilot
_pilotUniform = ["LOP_U_AA_Fatigue_02_slv"];
_pilotHelmet = ["H_PilotHelmetHeli_B"];
_pilotRig = ["LOP_V_CarrierLite_ANA"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["LOP_U_AA_Fatigue_02_slv"];
_crewHelmet = ["rhs_tsh4"];
_crewRig = ["LOP_V_Carrier_OLV"];
_crewGlasses = [];
