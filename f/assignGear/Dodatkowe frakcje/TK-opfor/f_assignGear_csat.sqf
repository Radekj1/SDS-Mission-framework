...
// Woodland-Hex
_baseUniform = ["U_TKA_A3_uniform_02"];
_baseHelmet = ["LOP_H_SSh68Helmet_OLV","H_TKA_A3_HelmetIA"];
_baseGlasses = [];

// Urban
//_baseUniform = ["U_TKA_A3_uniform","U_TKA_A3_uniform_02"];
//_baseHelmet = ["LOP_H_SSh68Helmet_OLV","H_TKA_A3_HelmetIA"];

// Vests
_lightRig = ["V_TKA_A3_ChestRig","rhs_vydra_3m","V_BandollierB_oli"];
_mediumRig = ["V_TKA_A3_ChestRig","rhs_vydra_3m","V_BandollierB_oli"]; 	// default for all infantry classes
_heavyRig = ["V_TKA_A3_ChestRig","rhs_vydra_3m","V_BandollierB_oli"];

// Diver
_diverUniform =  ["U_TKA_A3_uniform_02"];
_diverHelmet = [];
