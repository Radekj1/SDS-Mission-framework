...
_baseUniform = ["LOP_U_AA_Fatigue_01_slv"];
_baseHelmet = ["rhsusf_ach_bare_tan_headset_ess"];
_baseGlasses = [];

// Vests
_lightRig = ["LOP_V_CarrierLite_TAN","LOP_V_CarrierRig_TAN"];
_mediumRig = ["LOP_V_CarrierLite_TAN","LOP_V_CarrierRig_TAN"]; 	// default for all infantry classes
_heavyRig = ["LOP_V_CarrierLite_TAN","LOP_V_CarrierRig_TAN"];
