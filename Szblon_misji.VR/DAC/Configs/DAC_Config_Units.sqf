...
// USMC 2000 CUP (BLUFOR)
  case 12:
  {
    ...
    _Unit_Pool_V = ["CUP_B_HMMWV_M2_USMC", "CUP_B_HMMWV_M1114_USMC", "CUP_B_HMMWV_Avenger_USMC", "CUP_B_HMMWV_TOW_USMC", "CUP_B_LAV25M240_USMC", "CUP_B_M1126_ICV_M2_Woodland", "CUP_B_M1128_MGS_Woodland"];
...
// SLA (OPFOR)
  case 18:
  {
    ...
    _Unit_Pool_V = ["CUP_O_Ural_ZU23_SLA", "CUP_O_BRDM2_SLA", "CUP_O_BTR60_SLA"];
...
// USMC Pustynia 2010 RHS (BLUFOR)
    ...
    _Unit_Pool_V = ["CUP_B_HMMWV_M2_USA", "CUP_B_HMMWV_SOV_USA", "CUP_B_HMMWV_TOW_USA", "CUP_B_RG31_M2_USMC", "CUP_B_MTVR_USA"];
    _Unit_Pool_T = ["CUP_B_M1A1_DES_USMC", "CUP_B_LAV25M240_USMC"]; 
    _Unit_Pool_A = ["CUP_B_MH60S_FFV_USMC", "CUP_B_UH1Y_UNA_USMC", "CUP_B_UH1Y_GUNSHIP_USMC"];
  };
