...
// Dodatki broń główna
_attach1 = "CUP_acc_Flashlight";		// Latarka i laser (można przełączyć)
_attach2 = "";							// Laser i latarka (można przełączyć)
...
//_baghmgg = "";					// used by Heavy MG gunner
//_baghmgag = ;			// used by Heavy MG assistant gunner
