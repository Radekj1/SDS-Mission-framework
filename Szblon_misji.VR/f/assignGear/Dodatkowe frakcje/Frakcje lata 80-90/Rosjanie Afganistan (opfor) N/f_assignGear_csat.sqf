// F3 - Folk ARPS Assign Gear Script - Ruscy afgan
...
_bagMs = "CUP_B_AlicePack_Khaki";					// Plecak dla medyka (mały)
...
_bagENG = "CUP_B_AlicePack_Khaki";					// Plecak dla Mechanika
...
_baseHelmet = ["rhs_ssh68","rhs_ssh68","rhs_ssh68","rhs_ssh68","rhs_ssh68","H_Bandanna_sgg","H_Booniehat_tan","rhs_fieldcap_ml","CUP_H_C_Ushanka_02"];
_baseGlasses = [];
