// F3 - Folk ARPS Assign Gear Script - Takistan
	...
	_smg = "CUP_arifle_FNFAL_OSW";
	_smgmag = "CUP_20Rnd_762x51_FNFAL_M";
	_smgmag_tr = "CUP_20Rnd_762x51_FNFAL_M";
	...
	_bagTL = "CUP_B_AlicePack_Khaki";					//Plecak dowódcy drużyny
	
	_bagMs = "usm_pack_m5_medic";		// Plecak dla medyka (mały)
	_bagMm = "usm_pack_m5_medic";				// Plecak dla medyka (średni)
	_bagMb = "usm_pack_m5_medic";       		// Plecak dla medyka (duży)
	...
	// Kamizelki
	_lightRig = ["CUP_V_O_TK_Vest_1", "CUP_V_O_TK_Vest_2"];
	_mediumRig = ["CUP_V_O_TK_Vest_1", "CUP_V_O_TK_Vest_2"]; 	// default for all infantry classes
	_heavyRig = ["CUP_V_O_TK_Vest_1", "CUP_V_O_TK_Vest_2"];
	...
	// Pilot
	_pilotUniform = ["CUP_U_O_TK_Green"];
