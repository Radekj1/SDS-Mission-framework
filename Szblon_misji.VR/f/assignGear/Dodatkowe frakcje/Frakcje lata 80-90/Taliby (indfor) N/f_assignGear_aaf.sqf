// F3 - Folk ARPS Assign Gear Script - Taliby IND
...
// Bronie
	...
	_bagMs = "CUP_B_TK_AssaultPack_Medic";			// Plecak dla medyka (mały)
	_bagMm = "CUP_B_TK_AssaultPack_Medic";			// Plecak dla medyka (średni)
	_bagMb = "CUP_B_TK_AssaultPack_Medic";       	// Plecak dla medyka (duży)
...
// ====================================================================================
	...
	_baseUniform = ["CUP_I_TKG_Khet_Partug_07", "CUP_I_TKG_Khet_Partug_08","CUP_I_TKG_Khet_Jeans_04", "CUP_I_TKG_Khet_Jeans_03", "CUP_I_TKG_Khet_Partug_02", "CUP_I_TKG_Khet_Partug_06", "CUP_I_TKG_Khet_Partug_01", "CUP_I_TKG_Khet_Jeans_01","CUP_I_TKG_Khet_Jeans_02"];
	_baseHelmet = ["CUP_H_TKI_Pakol_2_04", "CUP_H_TKI_Lungee_06","CUP_H_TKI_Lungee_04",	"CUP_H_TKI_Lungee_Open_04","H_ShemagOpen_khk","CUP_H_TKI_Pakol_2_05","CUP_H_TKI_Lungee_05","CUP_H_TKI_Lungee_05","CUP_H_TKI_Lungee_Open_06"];
	_baseGlasses = [];
	
	// Kamizelki
	_lightRig = ["CUP_V_OI_TKI_Jacket1_05", "CUP_V_OI_TKI_Jacket3_06","CUP_V_OI_TKI_Jacket2_04", "CUP_V_OI_TKI_Jacket4_06", "CUP_V_OI_TKI_Jacket1_06", "CUP_V_OI_TKI_Jacket4_05", "CUP_V_OI_TKI_Jacket3_05","CUP_V_OI_TKI_Jacket4_04","CUP_V_OI_TKI_Jacket2_06"];
	_mediumRig = ["CUP_V_OI_TKI_Jacket1_05", "CUP_V_OI_TKI_Jacket3_06","CUP_V_OI_TKI_Jacket2_04", "CUP_V_OI_TKI_Jacket4_06", "CUP_V_OI_TKI_Jacket1_06", "CUP_V_OI_TKI_Jacket4_05", "CUP_V_OI_TKI_Jacket3_05","CUP_V_OI_TKI_Jacket4_04","CUP_V_OI_TKI_Jacket2_06","CUP_V_OI_TKI_Jacket4_02","CUP_V_OI_TKI_Jacket3_01"]; 	// default for all infantry classes
	_heavyRig = ["CUP_V_OI_TKI_Jacket1_05", "CUP_V_OI_TKI_Jacket3_06","CUP_V_OI_TKI_Jacket2_04", "CUP_V_OI_TKI_Jacket4_06", "CUP_V_OI_TKI_Jacket1_06", "CUP_V_OI_TKI_Jacket4_05", "CUP_V_OI_TKI_Jacket3_05","CUP_V_OI_TKI_Jacket4_04","CUP_V_OI_TKI_Jacket2_06"];
	...
	// Pilot
	_pilotUniform = ["CUP_I_TKG_Khet_Jeans_01"];
	_pilotHelmet = ["rhs_gssh18"];
	_pilotRig = ["CUP_V_OI_TKI_Jacket2_04"];
	_pilotGlasses = [];
	...
	// Załoga pojazdu
	_crewUniform = ["CUP_I_TKG_Khet_Jeans_01"];
	_crewHelmet = ["rhs_tsh4"];
	_crewRig = ["CUP_V_OI_TKI_Jacket2_04"];
	_crewGlasses = [];
