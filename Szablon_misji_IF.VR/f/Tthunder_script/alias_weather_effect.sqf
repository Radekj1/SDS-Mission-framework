...
// [[[],"ALthunder\alias_weather_effect.sqf"],"BIS_fnc_execVM",true,false] spawn BIS_fnc_MP;
...
//if ((_xx_speed>1) or (_yy_speed>1)) then {
...
while {true} do {
	...
	//hint str _alias_drop_fog_factor;
