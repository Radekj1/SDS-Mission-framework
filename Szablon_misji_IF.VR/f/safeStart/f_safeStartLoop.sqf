...
while {f_var_mission_timer > 0} do {
	...
	[["SafeStart",[format["Time left: %1 min",f_var_mission_timer]]],"bis_fnc_showNotification",true] call BIS_fnc_MP;
...
if (f_var_mission_timer == 0) then {
		...
		[["SafeStartMissionStarting",["Mission starts now!"]],"bis_fnc_showNotification",true] call BIS_fnc_MP;
