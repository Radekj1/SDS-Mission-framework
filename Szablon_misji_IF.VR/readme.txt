...
This mission is (c)[2017] S.D.S Polska. All rights reserved.
...
1. S.D.S Polska (hereafter 'The Author(s)') grant to you a personal, non-exclusive license to use the Software.
...
[@PSZ] - [http://www.armaholic.com/page.php?id=30087]
...
4.	Dodanie i implementacja śniegu 
5.	Dodanie i implementacja nowych parametrów pogody
6.	Dodanie i implementacja burzowej pogody
7.	Dodanie programatora TFAR po respie
8.	Dodanie celownika dla Strzelec MMG (zbugowana broń M240B)
9.	Dodanie celownika dla RKM Polacy
10.	Dodanie kompatybilności skryptu flar dla JIP
...
4.	Naprawa pilota samolotu (hełm buguje się gdy pilot dostaje gogle NVG, aktualnie hełm pilota ma wbudowaną noktowizje) (frakcje NATO)
5.	Zmiana radia długiego dla frakcji Indfor
6.	Poprawa skryptu dla skrzyń
7.	Poprawa flar i latarek
8.	Poprawa dodatków do broni – wszystkie frakcje
9.	Poprawa błędu AT, dodanie USMC LAW
10.	Poprawa błędu ze znikającą mgłą 
11.	Poprawa skryptu - Burza
12.	Optymalizacja skryptu śniegu
13.	Poprawione plecaki Novorosja – Medyk
14.	Zmiana pojazdu na zwykły Armowy Offroad M2 - Africa Militia
15.	Broń RKM [HLC] zmiana magazynków (75 nie działają)
16.	Zmiana klasy - Pilot Samolotu Czerwoni na właściwą