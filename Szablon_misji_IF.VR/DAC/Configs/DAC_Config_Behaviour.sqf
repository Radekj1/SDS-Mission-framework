...
//Domyślne zachowanie oraz OPFOR arty
	case 0:
	{
		//_setSkill = ["aimingAccuracy","aimingShake","aimingSpeed","Endurance","spotDistance","spotTime","courage","reloadSpeed","commanding","general"];
		_setSkill   = [[0.2,0.4],		[0.6,0.8],		[0.2,0.4],	[0.9,1.0],	[0.6,0.7],		[0.6,0.8],[0.9,1.0],[0.1,0.2],		[0.9,1.0],	[0.6,0.7]];
		...
		_setSupport = [1,1];//support for other zones //OPFOR arty
		_setJoin    = 2;
...
//Domyślne zachowanie oraz BLUFOR arty
	case 1:
	{
		//_setSkill = ["aimingAccuracy","aimingShake","aimingSpeed","Endurance","spotDistance","spotTime","courage","reloadSpeed","commanding","general"];
		_setSkill   = [[0.2,0.4],		[0.6,0.8],		[0.2,0.4],	[0.9,1.0],	[0.6,0.7],		[0.6,0.8],[0.9,1.0],[0.1,0.2],		[0.9,1.0],	[0.6,0.7]];
...
//Pełna prędkość, oraz OPFOR arty
case 2:
	{
		//_setSkill = ["aimingAccuracy","aimingShake","aimingSpeed","Endurance","spotDistance","spotTime","courage","reloadSpeed","commanding","general"];
		_setSkill   = [[0.2,0.4],		[0.6,0.8],		[0.2,0.4],	[0.9,1.0],	[0.6,0.7],		[0.6,0.8],[0.9,1.0],[0.1,0.2],		[0.9,1.0],	[0.6,0.7]];
...
//Pełna prędkość oraz BLUFOR arty
case 3:
	{
		//_setSkill = ["aimingAccuracy","aimingShake","aimingSpeed","Endurance","spotDistance","spotTime","courage","reloadSpeed","commanding","general"];
		_setSkill   = [[0.2,0.4],		[0.6,0.8],		[0.2,0.4],	[0.9,1.0],	[0.6,0.7],		[0.6,0.8],[0.9,1.0],[0.1,0.2],		[0.9,1.0],	[0.6,0.7]];
...
//Zachowanie polecane dla cywili (powoli i ostrożnie)
case 4:
	{
		//_setSkill = ["aimingAccuracy","aimingShake","aimingSpeed","Endurance","spotDistance","spotTime","courage","reloadSpeed","commanding","general"];
		//_setSkill   = [[0.1,0.3],		[0.6,0.8],		[0.2,0.4],	[0.3,0.4],	[0.4,0.5],		[0.6,0.8],[0.5,0.6],[0.1,0.2],		[0.6,0.8],	[0.3,0.5]];
		_setSkill   = [[0.2,0.4],		[0.6,0.8],		[0.2,0.4],	[0.9,1.0],	[0.6,0.7],		[0.6,0.8],[0.9,1.0],[0.1,0.2],		[0.9,1.0],	[0.6,0.7]];
		_setCombat  = ["green","white","yellow"];
		_setBehav   = ["careless"];
		_setSpeed   = ["limited"];
