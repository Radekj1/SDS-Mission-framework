...
// [[[_al_flare],"f\flare_fix\al_flare_enhance.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;
...
// you need to list in array bellow the class names for flares you want to alter  
	_type_flares = ["F_40mm_White","F_40mm_Red","F_40mm_Yellow","F_40mm_Green","rhs_40mm_white","rhs_40mm_green","rhs_40mm_red","rhs_40mm_Yellow"];
