...
// [[[poz_obj_fulger],"ALthunder\alias_thunder_one_effect.sqf"],"BIS_fnc_execVM",true,false] spawn BIS_fnc_MP;
...
_sound_f_close = ["t_close_2","t_close_9","t_close_12","t_close_14","t_close_18"] call BIS_fnc_selectRandom;
			...
			_fulger setParticleParams
				/*Sprite*/		[["\A3\data_f\blesk1",/*Ntieth*/ 1, /*Index*/0, /*Count*/1, /*loop*/0], "",
					...
					//	_fulger setVectorUp [0, 0, 1];
		//	_fulger setVelocity [0, 0, f_viteza];
