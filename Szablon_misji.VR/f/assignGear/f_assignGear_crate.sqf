...
// CARGO: LOGISTYKA - Przykład inicjalizacji: ["v_med",this,"blu_f"] call f_fnc_assignGear
	case "v_med":
	{
		...
		_unit addItemCargoGlobal [_nalbuphine, 30];
		_unit addItemCargoGlobal [_fentanyl, 30];
		_unit addItemCargoGlobal [_morphine, 30];
		_unit addItemCargoGlobal [_epinephrine, 30];
		_unit addItemCargoGlobal [_amiodarone, 30];
		_unit addItemCargoGlobal [_lidocaine, 30];
		_unit addItemCargoGlobal [_atropine, 30];
		_unit addItemCargoGlobal [_naloxone, 30];
		_unit addItemCargoGlobal [_chestSeal, 20];
		_unit addItemCargoGlobal [_AATKit, 20];
		_unit addItemCargoGlobal [_larynx, 20];
		_unit addItemCargoGlobal [_nitroglycerin, 20];
		_unit addItemCargoGlobal [_norepinephrine, 20];
		_unit addItemCargoGlobal [_Carbonate, 20];
		_unit addItemCargoGlobal [_iv16, 50];
		_unit addItemCargoGlobal [_ioFast, 20];
		_unit addItemCargoGlobal [_scalpel, 50];
		_unit addItemCargoGlobal [_splint, 30];
		_unit addItemCargoGlobal [_plasma_m, 30];
		_unit addItemCargoGlobal [_saline_s, 30];
		_unit addItemCargoGlobal [_splint, 15];
		_unit addItemCargoGlobal [_tourniquet, 15];
		_unit addItemCargoGlobal [_worek, 20];
		_unit addItemCargoGlobal [_transfuseKit, 30];
		_unit addItemCargoGlobal [_towRope, 1];
	};
...
// CRATE: Small ammo crate - should be enough for one fireteam
...

	{
		...
		_unit addMagazineCargoGlobal [_DMriflemag_tr, 10];
		_unit addMagazineCargoGlobal [_glmag, 30];
...
// CRATE: Medium ammo crate = should be enough for one squad
...

	{
		...
		_unit addMagazineCargoGlobal [_DMriflemag_tr, 15];
...
// CRATE: Big ammo crate = should be enoug for platoon to rearm
	...
	
	{
		...
		_unit addMagazineCargoGlobal [_DMriflemag_tr, 25];
		_unit addMagazineCargoGlobal [_glmag, 100];
		_unit addMagazineCargoGlobal [_glsmokewhite,20];
		_unit addMagazineCargoGlobal [_glsmokegreen,20];
		_unit addMagazineCargoGlobal [_glsmokered,20];
...
// CRATE: Mała skrzynka, zasoby medyczne
	case "crate_smallmedical":
	{
		...
		_unit addItemCargoGlobal [_AATKit, 20];
		_unit addItemCargoGlobal [_larynx, 20];
		_unit addItemCargoGlobal [_nitroglycerin, 10];
		_unit addItemCargoGlobal [_norepinephrine, 10];
		_unit addItemCargoGlobal [_Carbonate, 20];
		_unit addItemCargoGlobal [_iv16, 50];
		_unit addItemCargoGlobal [_splint, 30];
		_unit addItemCargoGlobal [_plasma_m, 30];
		_unit addItemCargoGlobal [_saline_s, 10];
		_unit addItemCargoGlobal [_splint, 15];
		_unit addItemCargoGlobal [_tourniquet, 15];
		_unit addItemCargoGlobal [_personalAidKit, 10];
		_unit addItemCargoGlobal [_worek, 20];
		_unit addItemCargoGlobal [_Pulseoximeter, 4];
		_unit addItemCargoGlobal [_transfuseKit, 30];
	};
