...
switch (_typeofCrate) do
{
	...
	case "crate_food":			{ _mycrate = "Box_NATO_Support_F"; };
	case "track":				{ _mycrate = "ACE_Track"; };
	case "wheel":				{ _mycrate = "ACE_Wheel"; };
	case "jerrycan":			{ _mycrate = "Land_CanisterFuel_F"; };
	case "british_landover":	{ _mycrate = "B_CargoNet_01_ammo_F"; };
	case "british_ifv":			{ _mycrate = "B_CargoNet_01_ammo_F"; };
	case "british_static":		{ _mycrate = "B_CargoNet_01_ammo_F"; };
};
...
_null = this addAction ["Food", "f\assignGear\SpawnCrate.sqf", ["crate_food",faction1] ]; " \n "
...
_null = this addAction ["British Landover Ammo", "f\assignGear\SpawnCrate.sqf", ["british_landover",faction1] ]; " \n "
_null = this addAction ["British IFV Ammo", "f\assignGear\SpawnCrate.sqf", ["british_ifv",faction1] ]; " \n "
_null = this addAction ["British Static Ammo", "f\assignGear\SpawnCrate.sqf", ["british_static",faction1] ];"
/*
